  ...
  <div id="mutation">
    <div>
      ...
      <div style="text-align: left ;margin-left: 60px;margin-top: 20px">
        <br>
        <p>
          <span style="font-weight: bold;font-size: 24px;color: #3a8ee6">Mutation
          </span>
        ...
        <div v-show="Showhelp" style="font-size: 13px;line-height: 1.5;color: #4d4d4d">
          <p>
            ...
            <span>
            The function of this module is to analyse genes mutated in pan-cancer.
          </span>
          </p>
        </div>
      </div>
    ...
    <div style="margin: 20px; text-align: center">
      ...
      <el-button type="primary" class="hover-blue-btn" @click="logfcAndMut">Click</el-button>
    </div>
